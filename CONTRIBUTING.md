...
## Report bugs using Github's [issues](https://github.com/sopherapps/alpml/issues)

We use GitHub issues to track public bugs. Report a bug
by [opening a new issue](https://github.com/sopherapps/alpml/issues); it's that easy!
...
- Ensure you have [nodejs +v16](https://nodejs.org/en/) installed.

- Clone the repo and enter its root folder

  ```bash
  git clone https://github.com/sopherapps/alpml.git && cd alpml
  ```
